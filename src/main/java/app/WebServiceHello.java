...
public class WebServiceHello {
	...
	public static String square() {
		return "<html><head><meta charset=\"utf-8\" /><title>Proyecto AREM</title></head><body><h1> Cuadrado </h1></body></html>";
	}
	/**
	 * 
	 * @return un HTML de ejemplo
	...
	public static String square1() {
		return "<html><head><meta charset=\"utf-8\" /><title>Proyecto AREM</title></head><body><h1> Cuadrado 1 </h1></body></html>";
	}
	/**
	 * 
	 * @param name
